...
#ifndef FREE
        const int AddField(const QString &pTemplate, const QString &pName, const qfFieldAttributes &pAttributes, const eFieldBuiltIn &pBuiltIn, const eFieldLanguage &pLanguage) const;
#endif
